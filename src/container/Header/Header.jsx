...
<div style={{marginLeft:20}}>
  ...
  <h1 className='head-text head-head' >Ranbir Singh</h1>
</div>
</div>
...
<a href={resume} target='_blank' download={resume} ><button className='app__header-btn' onClick={()=>window.open("https://drive.google.com/file/d/1l45dTeo6x8a9Y8QamReRiCRvxlPHzlXG/view")}>Resume</button></a>
